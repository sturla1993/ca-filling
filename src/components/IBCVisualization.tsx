...
export const IBCVisualization = ({ currentWeight, targetWeight, maxCapacity }: IBCVisualizationProps) => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 p-6 bg-card rounded border border-border">
      <h3 className="text-lg font-semibold text-foreground">IBC Container</h3>
      
      {/* IBC Container Visualization */}
      <div className="relative w-48 h-64 bg-tank-empty border-2 border-border rounded-lg overflow-hidden">
        {/* Target line */}
        <div
      ...
      <div className="grid grid-cols-3 gap-4 w-full">
        <div className="text-center">
          <div className="text-xs text-muted-foreground mb-1">Nåværende</div>
        ...
        <div className="text-center">
          <div className="text-xs text-muted-foreground mb-1">Mål</div>
        ...
        <div className="text-center">
          <div className="text-xs text-muted-foreground mb-1">Kapasitet</div>
